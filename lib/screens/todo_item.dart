...
class _TodoItemState extends State<TodoItem> {
  ...
  _TodoItemState(Todo todo, int index) {
    ...
    if (_todo != null) {
      ...
      _descricaoControler.text = _todo.descricao;
    }
  }

  _saveItem() async {
    if(_tituloController.text.isEmpty || _descricaoControler.text.isEmpty) {
    ...
    _todo = new Todo.fromTituloDescricao(
        _tituloController.text, _descricaoControler.text);
    if (_index != -1) {
      list[_index] = _todo;
    } else {
      list.add(_todo);
